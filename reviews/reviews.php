...
$stmt_cc = $conn->prepare("SELECT SUM(quantity) as total_items FROM cart WHERE user_id = ?");
$stmt_cc->bind_param("i", $uid);
$stmt_cc->execute();
$cart_count = $stmt_cc->get_result()->fetch_assoc()['total_items'] ?? 0;
$stmt_cc->close();
